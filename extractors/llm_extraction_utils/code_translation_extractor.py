# extractors/code_translation_extractor.py
...
class CodeTranslationExtractor(BaseLLMExtractor):
    """
    Code extractor for code translation tasks.
...
{response_text}"""
    ...
    def _process_entry(self, raw_line: str, state: Dict[str, Any], responses_per_entry: int):
        ...
        try:
            ...
            target_language = data.get('target_lang', 'unknown')
        except Exception:
            return None

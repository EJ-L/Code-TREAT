...
class CodeSummarizationRunner(BaseTaskRunner):
    """Unified runner for code summarization."""
    
    def __init__(self, config: TaskConfig):
        self.task_name = "code_summarization"
    ...
    def process_work_item(self, work_item: Tuple) -> Dict[str, Any]:
        ...
        try:
            ref_key = RecordManager.make_ref_key(self.config.dataset, model_name, data.url, self.config.template_categories, template.template_id)

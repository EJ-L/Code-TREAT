...
class DatasetManager:
    def __init__(self, task_name: str, dataset: str, language: str, reproduce: bool = True):
    ...
    def load_dataset(self) -> List[Any]:
        ...
        if self.task_name == "vulnerability_detection":
            ...
            return VulnerabilityDetectionDataLoader(self.dataset, reproduce=self.reproduce).load_data()
        if self.task_name == "code_summarization":
            ...
            return CodeSummarizationDataLoader(self.dataset, self.language, reproduce=self.reproduce).load_data()
        if self.task_name == "code_review_generation":
            ...
            return CodeReviewGenerationDataLoader(self.dataset, self.language, reproduce=self.reproduce).load_data()
        if self.task_name == "unit_test_generation":
            ...
            return UnitTestGenerationDataLoader(self.dataset, reproduce=self.reproduce).load_data()
        if self.task_name == "input_prediction":
            ...
            return InputPredictionDataLoader(self.dataset, self.language, reproduce=self.reproduce).load_data()
        if self.task_name == "output_prediction":
            ...
            return OutputPredictionDataLoader(self.dataset, self.language, reproduce=self.reproduce).load_data()
